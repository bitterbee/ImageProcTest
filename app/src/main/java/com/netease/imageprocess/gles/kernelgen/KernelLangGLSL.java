package com.netease.imageprocess.gles.kernelgen;
...
public class KernelLangGLSL extends AbstractKernelLang {
    ...
    private void setDefaults() {
        ...
        pT[P_V_TEX_COORD] = "varying vec2";
        p[P_V_TEX_COORD] = "vTexCoord";
        pT[P_U_PX_D] = "uniform vec2";
        p[P_U_PX_D] = "uPxD";
        pT[P_S_TEXTURE] = "uniform sampler2D";
        p[P_S_TEXTURE] = "sTexture";
        pT[P_A_TEX_COORD] = "attribute vec2";
        p[P_A_TEX_COORD] = "aTexCoord";
        pT[P_A_POS] = "attribute vec4";
        p[P_A_POS] = "aPos";
        pT[P_U_MVPMAT] = "uniform mat4";
        p[P_U_MVPMAT] = "uMVPMatrix";
